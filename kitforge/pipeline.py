...
def build_kit(
    ...
    expected_stems = ["htdemucs_6s", "htdemucs_ft", "htdemucs"][0:1]  # placeholder

    # Determine which stems we expect from the chosen model
    if six_stem:
    ...
    if instrument_lower in _DRUM_INSTRUMENTS:
        ...
        raise NotImplementedError(
            ...
            "Supported: drums, bass, bass guitar, synth bass, 808"
        )
